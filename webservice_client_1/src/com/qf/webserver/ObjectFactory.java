 ...
 * generated in the com.qf.webserver package. 
...
public class ObjectFactory {
    ...
    private final static QName _OtherResponse_QNAME = new QName("http://webserver.qf.com/", "otherResponse");
    private final static QName _Query_QNAME = new QName("http://webserver.qf.com/", "query");
    private final static QName _QueryResponse_QNAME = new QName("http://webserver.qf.com/", "queryResponse");
    private final static QName _Other_QNAME = new QName("http://webserver.qf.com/", "other");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.qf.webserver
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserver.qf.com/", name = "otherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserver.qf.com/", name = "query")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserver.qf.com/", name = "queryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserver.qf.com/", name = "other")
